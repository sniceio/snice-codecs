...
public class TestUpdateLocation extends io.snice.codecs.codec.diameter.DiameterTestBase {
    ...
    public void testFrameULA() throws Exception {
        ...
        assertThat(resultCode.get().getAsEnum().get(), is(ResultCode.DiameterSuccess2001.getAsEnum().get()));
