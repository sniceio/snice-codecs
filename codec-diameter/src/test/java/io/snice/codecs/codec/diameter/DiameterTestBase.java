...
public class DiameterTestBase {
    ...
    public static final RawDiameterMessageHolder[] RAW_DIAMETER_MESSAGES = new RawDiameterMessageHolder[]{
            ...
            new RawDiameterMessageHolder("015_ula_imsi_unknown.raw", 176, false, false, false, false, 316, 16777251L, 0x3cbeb4a8, 0xcb03f85c, 5),
    ...
    public static ReadableBuffer loadBuffer(final String resource) throws Exception {
        ...
        final var ios = DiameterTestBase.class.getResourceAsStream(resource);
        ios.read(buffer);
        return Buffers.wrap(buffer).toReadableBuffer();
    }
