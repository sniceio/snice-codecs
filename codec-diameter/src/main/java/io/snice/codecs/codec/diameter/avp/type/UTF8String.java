...
public interface UTF8String extends DiameterType {
    ...
    static UTF8String parse(final String data) {
        return new DefaultUTF8String(Buffer.of(data.getBytes(StandardCharsets.UTF_8)));
    }

    static UTF8String parse(final int data) {
        return new DefaultUTF8String(Buffer.of(Integer.toString(data).getBytes(StandardCharsets.UTF_8)));
    }

    static UTF8String parse(final long data) {
        return new DefaultUTF8String(Buffer.of(Long.toString(data).getBytes(StandardCharsets.UTF_8)));
    }
