...
public interface DiameterIdentity extends DiameterType {
    ...
    static DiameterIdentity parse(final String data) {
        assertArgument(data != null && !data.isEmpty());
        return new DefaultDiameterIdentity(Buffers.wrap(data));
    }

    static DiameterIdentity parse(final int data) {
        // TODO: not sure this makes sense.
        return parse(String.valueOf(data));
    }

    static DiameterIdentity parse(final long data) {
        // TODO: not sure this makes sense.
        return parse(String.valueOf(data));
    }
